...
- Test the Playlist Rename command (Artists, Albums and songs).
- Test the Playlist Copy command (Artists, Albums and songs).
- Test the Playlist Delete command (Artists, Albums and songs).
